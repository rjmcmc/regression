...
\hypersetup{unicode=true,
            pdftitle={Regression Analysis using R and SAS},
            pdfauthor={Sungchan Kang},
            pdfborder={0 0 0},
            breaklinks=true}
...
\setlength{\droptitle}{-2em}
  ...
  \title{Regression Analysis using R and SAS}
...
A \emph{matrix} is a square shape array of numbers (sometimes can be string). In this book, boldface letters mean matrices. For example,
\[
\mathbf{A}=
\begin{pmatrix}
65 & 154 \\
